...
public class ClericSpellcasting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cleric_spellcasting);
        ...
        myLayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (((x2 - x1) > 0) && beeingUsed == false && (Math.abs(x2 - x1) > 200)) {
                    ...
                    Intent newIntent = new Intent(getApplicationContext(), ClericFeatures.class);
                ...
                //next
                if (((x2 - x1) < 0) && (beeingUsed == false) && (Math.abs(x2 - x1) > 200)) {
                    Intent newIntent = new Intent(getApplicationContext(), ClericAbilityDetail.class);
                    startActivity(newIntent);
    ...
    public void onChooseButtonclick(View view) {
        ...
        String klasa = "Cleric";
        String mainStats = "Wisdom/Strength/Constitution";
